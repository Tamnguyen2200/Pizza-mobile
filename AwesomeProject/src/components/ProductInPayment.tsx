...
function ProductInPayment({
  ...
  Cheese,
  TotalPrice,
  onSelectRemoveProduct,
  onCalculatedPriceChange,
}: ProductInPaymentProps): JSX.Element {
  ...
  return (
    <View
      ...
      <View
        ...
        <Image source={{uri: Pizza.Image}} style={{width: 100, height: 100}} />
        <View>
          <Text
            style={{
              color: '#000000',
          ...
          <Text
            ...
            {Size.SizeName}, {Thickness.ThicknessName},{Cheese.CheeseName}
          </Text>
          <Text
            style={{
              color: '#000000',
          ...
          <View
            ...
            <View
              ...
              <Text style={{color: '#000000', fontSize: 13, marginTop: 4}}>
                {quantity}
              </Text>
